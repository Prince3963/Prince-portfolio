      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="text-xl font-bold">
            <NavLink to="/" onClick={closeMenu} className="hover:text-gray-300">
              Prince Portfolio
            </NavLink>
          </div>
          ...
          <ul className="hidden md:flex space-x-6">
            ...
            <li><NavLink to="/about" className={navLinkStyle} onClick={closeMenu}>About Me</NavLink></li>
            <li><NavLink to="/skills" className={navLinkStyle} onClick={closeMenu}>Skills</NavLink></li>
            <li><NavLink to="/projects" className={navLinkStyle} onClick={closeMenu}>Projects</NavLink></li>
